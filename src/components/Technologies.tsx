...
export default function Technologies() {
  return (
    <div className="flex justify-center p-3 gap-2 bg-white flex-wrap text-sm sm:rounded-tl-lg sm:text-lg">
          <div className="flex items-center justify-center p-5 rounded-lg bg-blue-500 w-auto">
            <svg
          ...
          <div className="flex items-center justify-center gap-2 p-5 rounded-lg bg-blue-500 w-auto">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="30"
              height="30"
